...
int main()
{
    ...
    Shader shaderGeometryPass("ssaoShaders/ssao_geometry.vs", "ssaoShaders/ssao_geometry.frag");
    Shader shaderLightingPass("ssaoShaders/ssao.vs", "ssaoShaders/ssao_lighting.frag");
    Shader shaderSSAO("ssaoShaders/ssao.vs", "ssaoShaders/ssao.frag");
    Shader shaderSSAOBlur("ssaoShaders/ssao.vs", "ssaoShaders/ssao_blur.frag");
